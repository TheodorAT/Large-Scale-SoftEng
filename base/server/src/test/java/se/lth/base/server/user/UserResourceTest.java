...
public class UserResourceTest extends BaseResourceTest {
    ...
    public void dontDemoteYourself() {
        login(ADMIN_CREDENTIALS);
        Credentials update = new Credentials("admin", "password", Role.USER, "User", "User", "user@user05.se", "+4600000001");
    ...
    public void updateUser() {
        login(ADMIN_CREDENTIALS);
        Credentials newTest = new Credentials("test2", null, Role.ADMIN, "User", "User", "user@user06.se", "+4600000001");
